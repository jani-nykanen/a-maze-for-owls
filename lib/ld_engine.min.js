...
Core.prototype.init=function(a,b){var c=this;this.assets=new AssetPack(a);this.graphics=new GraphicsCore(this.assets.bitmaps);this.input=new InputManager;this.audio=new AudioPlayer;this.vpad=new Vpad(this.input,b);this.tr=new Transition;this.evMan=new EventManager(this,this.audio,this.assets.sounds,this.vpad,this.tr);window.addEventListener("resize",function(){c.graphics.resize(window.innerWidth,window.innerHeight)});for(b=0;b<this.scenes.length;++b)a=this.scenes[b],null!=a.init&&a.init(this.evMan)};
Core.prototype.update=function(a){a/=1/60;null!=this.activeScene&&null!=this.activeScene.update&&this.activeScene.update(this.evMan,a);null!=this.globalScene&&null!=this.globalScene.update&&this.globalScene.update(this.evMan,a);this.input.update();this.vpad.update();this.tr.update(a)};
...
Core.prototype.run=function(a,b,c){var d=this;this.framerate=null==a?30:a;this.init(b,c);window.requestAnimationFrame(function(a){return d.loop(a)})};Core.prototype.changeScene=function(a,b){for(var c=0;c<this.scenes.length;++c)if(this.scenes[c].name==a&&(this.activeScene=this.scenes[c],null!=this.activeScene.onChange)){this.activeScene.onChange(b);break}};Core.prototype.addScene=function(a,b,c){this.scenes.push(a);b&&(this.activeScene=a);c&&(this.globalScene=a)};var EventManager=function(a,b,c,d,e){this.core=a;this.audio=b;this.sounds=c;this.vpad=d;this.transition=e};EventManager.prototype.changeScene=function(a,b){this.core.changeScene(a,b)};var Vpad=function(a,b){this.input=a;this.stick=new Vec2;this.oldStick=this.stick.copy();this.stickDelta=new Vec2;this.buttons={};if(null!=b)for(var c in b.buttons)this.buttons[c]={key:b.buttons[c],state:State.Up}};
Vpad.prototype.update=function(){this.oldStick.x=this.stick.x;this.oldStick.y=this.stick.y;this.stick.x=0;this.stick.y=0;this.input.getKey(37)==State.Down?this.stick.x=-1:this.input.getKey(39)==State.Down&&(this.stick.x=1);this.input.getKey(38)==State.Down?this.stick.y=-1:this.input.getKey(40)==State.Down&&(this.stick.y=1);this.stickDelta.x=this.stick.x-this.oldStick.x;this.stickDelta.y=this.stick.y-this.oldStick.y;for(k in this.buttonKeys)this.buttons[k].state=this.input.getKey(this.buttons[k].key)};var Flip={None:0,Horizontal:1,Vertical:2,Both:3},GraphicsCore=function(a){this.canvas=document.getElementById("canvas");this.ctx=this.canvas.getContext("2d");this.ctx.imageSmoothingEnabled=!1;this.resize(window.innerWidth,window.innerHeight);this.bitmaps=a};GraphicsCore.prototype.getColorString=function(a,b,c,d){null==d&&(d=1);return"rgba("+String(a|0)+","+String(b|0)+","+String(c|0)+","+String(d)+")"};
GraphicsCore.prototype.resize=function(a,b){var c=this.canvas,d=Math.min(a/c.width|0,b/c.height|0);var e=c.width*d;d*=c.height;b=String(b/2-d/2|0)+"px";a=String(a/2-e/2|0)+"px";c.style.height=String(d|0)+"px";c.style.width=String(e|0)+"px";c.style.top=b;c.style.left=a};GraphicsCore.prototype.setGlobalAlpha=function(a){null==a&&(a=1);this.ctx.globalAlpha=a};GraphicsCore.prototype.clear=function(a,b,c){var d=this.ctx;d.fillStyle=this.getColorString(a,b,c);d.fillRect(0,0,this.canvas.width,this.canvas.height)};
GraphicsCore.prototype.drawBitmap=function(a,b,c,d){this.drawBitmapRegion(a,0,0,a.width,a.height,b,c,d)};GraphicsCore.prototype.drawScaledBitmap=function(a,b,c,d,e,f){this.drawScaledBitmapRegion(a,0,0,a.width,a.height,b,c,d,e,f)};GraphicsCore.prototype.drawBitmapRegion=function(a,b,c,d,e,f,h,g){this.drawScaledBitmapRegion(a,b,c,d,e,f,h,d,e,g)};
GraphicsCore.prototype.drawScaledBitmapRegion=function(a,b,c,d,e,f,h,g,n,m){if(!(0>=g||0>=n||0>=d||0>=e)){b|=0;c|=0;d|=0;e|=0;f|=0;h|=0;g|=0;n|=0;m|=Flip.None;var l=this.ctx;m!=Flip.None&&l.save();0!=(m&Flip.Horizontal)&&(l.translate(g,0),l.scale(-1,1),f*=-1);0!=(m&Flip.Vertical)&&(l.translate(0,n),l.scale(1,-1),h*=-1);l.drawImage(a,b,c,d,e,f,h,g,n);m!=Flip.None&&l.restore()}};
GraphicsCore.prototype.drawText=function(a,b,c,d,e,f,h){var g=a.width/16,n=b.length,m=c;h&&(m=c-=n/2*(g+e));for(var l=0;l<n;++l){var p=b.charCodeAt(l);"\n"==p?(m=c,d+=f+g):(h=p%16,p=p/16|0,this.drawBitmapRegion(a,h*g,p*g,g,g,m,d,Flip.NONE),m+=g+e)}};GraphicsCore.prototype.fillRect=function(a,b,c,d,e){var f=this.ctx;null!=e&&(f.fillStyle=this.getColorString(e.r,e.g,e.b,e.a));f.fillRect(a|0,b|0,c|0,d|0)};var State={Up:0,Down:1,Pressed:2,Released:3},InputManager=function(){var a=this;window.addEventListener("keydown",function(b){b.preventDefault();a.keyPressed(b.keyCode)});window.addEventListener("keyup",function(b){b.preventDefault();a.keyReleased(b.keyCode)});window.addEventListener("mousedown",function(a){window.focus();a.preventDefault()});this.keyStates=Array(256);for(var b=0;b<this.keyStates.length;++b)this.keyStates[b]=State.Up;this.anyKeyPressed=!1};
InputManager.prototype.keyPressed=function(a){0>a||a>=this.keyStates.length||this.keyStates[a]==State.Down||(this.keyStates[a]=State.Pressed,this.anyKeyPressed=!0)};InputManager.prototype.keyReleased=function(a){0>a||a>=this.keyStates.length||this.keyStates[a]==State.Up||(this.keyStates[a]=State.Released)};
InputManager.prototype.update=function(){this.anyKeyPressed=!1;for(var a=0;a<this.keyStates.length;++a)this.keyStates[a]==State.Pressed?this.keyStates[a]=State.Down:this.keyStates[a]==State.Released&&(this.keyStates[a]=State.Up)};InputManager.prototype.getKey=function(a){return 0>a||a>=this.keyStates.length?State.Up:this.keyStates[a]};var AnimatedSprite=function(a,b){this.width=a;this.height=b;this.count=this.row=this.frame=0};AnimatedSprite.prototype.animate=function(a,b,c,d,e){b==c?(this.count=0,this.frame=b,this.row=a):(this.row!=a&&(this.count=0,this.frame=c>b?b:c,this.row=a),b<c&&this.frame<b?this.frame=b:c<b&&this.frame<c&&(this.frame=c),this.count+=1*e,this.count>d&&(b<c?++this.frame>c&&(this.frame=b):--this.frame<c&&(this.frame=b),this.count-=d))};
AnimatedSprite.prototype.drawFrame=function(a,b,c,d,e,f,h){a.drawBitmapRegion(b,this.width*c,this.height*d,this.width,this.height,e,f,h)};AnimatedSprite.prototype.draw=function(a,b,c,d,e){this.drawFrame(a,b,this.frame,this.row,c,d,e)};var INITIAL_TRANSITION_TIME=60,Fade={In:0,Out:1},Transition=function(){this.timer=0;this.speed=1;this.color={r:0,g:0,b:0};this.active=!1;this.division=-1;this.cb=null};Transition.prototype.activate=function(a,b,c,d,e){this.mode=a;this.speed=b;this.cb=c;this.active=!0;this.timer=INITIAL_TRANSITION_TIME;this.division=null==e?-1:e;null!=d?this.color=d:(this.color.r=0,this.color.g=0,this.color.b=0)};
