...
GraphicsCore.prototype.drawText=function(a,b,c,d,e,f,h){var g=a.width/16,n=b.length,m=c;h&&(m=c-=n/2*(g+e));for(var l=0;l<n;++l){var p=b.charCodeAt(l);"\n"==p?(m=c,d+=f+g):(h=p%16,p=p/16|0,this.drawBitmapRegion(a,h*g,p*g,g,g,m,d,Flip.NONE),m+=g+e)}};GraphicsCore.prototype.fillRect=function(a,b,c,d,e){var f=this.ctx;null!=e&&(f.fillStyle=this.getColorString(e.r,e.g,e.b,e.a));a+=this.tr.x;b+=this.tr.y;f.fillRect(a|0,b|0,c|0,d|0)};
